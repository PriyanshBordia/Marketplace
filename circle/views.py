...
def addPerson(request):
    try:
        ...
        return render(request, "circle/error.html",
    ...
    if type == 'person':
            ...
            if request.POST:
                ...
                return render(request, "circle/error.html",
                              context={"message": "Invalid Data.!!",
                                       "type": "Type Error", "link": "search"})
            form = PersonForm(instance=person)
            return render(request, "circle/person.html",
        ...
        try:
            ...
            if request.POST:
                ...
                return render(request, "circle/error.html",
                              context={"message": "Invalid Data.!!",
                                       "type": "Type Error", "link": "articles"})
            form = ArticleForm(instance=article)
            return render(request, "circle/article.html",
...
def friends(request):
    try:
        ...
        return render(request, "circle/error.html", context={"message": "You don't have any friends.!!", "type": "Data Error", "link": "search"})
    except Chat.DoesNotExist:
